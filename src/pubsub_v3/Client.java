...
public class Client {
    public static void main(String[] args) {
        if (args.length != 4) {
            System.out.println("Usage: java MyClient <server ip> <port number> <PUBLISHER/SUBSCRIBER> <TOPIC>");
            return;
        }
        ...
        String topic = args[3].trim().toUpperCase();
        ...
        try (
            ...
            System.out.println("Connected to server as " + clientType + " on topic " + topic);
